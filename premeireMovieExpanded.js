...
console.log(id)
const premeireMovieContainerEl = document.querySelector(".expandedPremeireMovie-container")
...
const renderCast = async () => {
    ...
    casts.forEach((c) => {
        ...
        <div class="cast-container">
          ...
          `
          premeireMovieContainerEl.appendChild(castElCon)
    })
}
//----------------------------------------------------------------------------------------------
...
const renderCrew = async () => {
    ...
    crews.forEach((c) => {
        ...
        premeireMovieContainerEl.appendChild(crewElCon)
    })
}
...
const renderReviews = async () => {
    ...
    reviews.forEach((rev) => {
        ...
        reviewCon.innerHTML += `
          ...
          `
          premeireMovieContainerEl.appendChild(reviewCon)
    })
}
