...
console.log(id)
const popularMoviesContainerEl = document.querySelector(".expandedPopularMovies-container")
...
const renderCast = async () => {
    ...
    casts.forEach((c) => {
        ...
        <div class="cast-container">
          ...
          `
          popularMoviesContainerEl.appendChild(castElCon)
    })
}
//----------------------------------------------------------------------------------------------
...
const renderCrew = async () => {
    ...
    crews.forEach((c) => {
        ...
        popularMoviesContainerEl.appendChild(crewElCon)
    })
}
...
const renderReviews = async () => {
    ...
    reviews.forEach((rev) => {
        ...
        reviewCon.innerHTML += `
          ...
          `
          popularMoviesContainerEl.appendChild(reviewCon)
    })
}
